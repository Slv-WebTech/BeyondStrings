...
function getBackgroundThemeTokens(tone) {
    const tokens = {
        'formal-soft': {
            ...
            overlayMid: 'rgba(250,252,255,0.62)',
            overlayBottom: 'rgba(245,248,252,0.74)',
            sentStart: 'rgba(122, 136, 156, 0.94)',
            sentEnd: 'rgba(160, 172, 188, 0.92)',
            sentBorder: 'rgba(122, 136, 156, 0.3)',
            sentShadow: '0 8px 16px rgba(71, 85, 105, 0.16), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
            tailSent: '#d1dae5',
            receivedStart: 'rgba(255,255,255,0.97)',
            receivedEnd: 'rgba(244,247,251,0.93)',
            receivedBorder: 'rgba(203,213,225,0.86)',
            receivedShadow: '0 8px 14px rgba(15, 23, 42, 0.08), inset 0 0 0 1px rgba(255,255,255,0.4)'
        },
        'formal-night': {
            accent: '#aab6c7',
            overlayTop: 'rgba(8,13,21,0.6)',
            overlayMid: 'rgba(11,17,26,0.52)',
            overlayBottom: 'rgba(9,14,22,0.68)',
            sentStart: 'rgba(88, 102, 121, 0.92)',
            sentEnd: 'rgba(115, 130, 148, 0.92)',
            sentBorder: 'rgba(154, 167, 184, 0.28)',
            sentShadow: '0 10px 18px rgba(15, 23, 42, 0.3), inset 0 1px 0 rgba(255,255,255,0.12)',
            tailSent: '#516075',
            receivedStart: 'rgba(28,38,50,0.95)',
            receivedEnd: 'rgba(23,32,43,0.92)',
            receivedBorder: 'rgba(100,116,139,0.45)',
            receivedShadow: '0 8px 14px rgba(0, 0, 0, 0.22)'
        },
        'romantic-soft': {
            accent: '#8f6a79',
            overlayTop: 'rgba(255,248,251,0.72)',
            overlayMid: 'rgba(251,241,246,0.62)',
            overlayBottom: 'rgba(248,236,242,0.74)',
            sentStart: 'rgba(180, 142, 158, 0.94)',
            sentEnd: 'rgba(208, 175, 189, 0.92)',
            sentBorder: 'rgba(180, 142, 158, 0.3)',
            sentShadow: '0 8px 16px rgba(136, 101, 117, 0.18), inset 0 1px 0 rgba(255,255,255,0.2)',
            tailSent: '#d8bdc8',
            receivedStart: 'rgba(255,249,251,0.97)',
            receivedEnd: 'rgba(246,236,241,0.94)',
            receivedBorder: 'rgba(226,203,214,0.86)',
            receivedShadow: '0 8px 14px rgba(72, 46, 59, 0.08), inset 0 0 0 1px rgba(255,255,255,0.35)'
        },
        'romantic-night': {
            accent: '#c5a8b5',
            overlayTop: 'rgba(30,22,28,0.62)',
            overlayMid: 'rgba(33,24,31,0.54)',
            overlayBottom: 'rgba(28,20,26,0.7)',
            sentStart: 'rgba(122, 92, 106, 0.92)',
            sentEnd: 'rgba(151, 116, 130, 0.92)',
            sentBorder: 'rgba(193,160,175,0.28)',
            sentShadow: '0 10px 18px rgba(42, 28, 36, 0.34), inset 0 1px 0 rgba(255,255,255,0.14)',
            tailSent: '#875f72',
            receivedStart: 'rgba(56,42,50,0.94)',
            receivedEnd: 'rgba(46,34,42,0.92)',
            receivedBorder: 'rgba(159,132,145,0.32)',
            receivedShadow: '0 8px 14px rgba(0, 0, 0, 0.25)'
        }
    };
