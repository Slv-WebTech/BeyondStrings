    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mx-auto w-full max-w-4xl">
                <div className="mb-1 flex items-center justify-between gap-1.5 text-[10px] text-[var(--text-muted)] md:mb-1.5 md:gap-2 md:text-[11px]">
                    <button
                        type="button"
                        onMouseEnter={() => revealBadgeText('connection')}
                        onClick={() => revealBadgeText('connection')}
                        className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-white/35 bg-white/26 p-0 shadow-[0_8px_20px_rgba(15,23,42,0.12)] backdrop-blur-lg transition-all duration-200 hover:bg-white/34 dark:border-slate-300/20 dark:bg-slate-900/34 dark:hover:bg-slate-900/44 md:h-8 md:w-8"
                ...
                <div className="rounded-[1.4rem] border border-white/22 bg-[linear-gradient(180deg,rgba(255,255,255,0.26),rgba(255,255,255,0.08))] p-1.5 shadow-[0_10px_22px_rgba(15,23,42,0.12)] backdrop-blur-xl dark:border-slate-300/15 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.42),rgba(2,6,23,0.16))] md:p-2">
